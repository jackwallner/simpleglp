...
PACKS: dict = {
    "ja": _PACK(
        "Simple GLP - GLP-1注射記録",
        "GLP1 オゼンピック ウゴービ",
        _JA_DESC,
        "マンジャロ,ゼップバウンド,セマグルチド,チルゼパチド,ペプチド,リマインダー,プライベート,用量,週次,注射,記録",
    ),
    "ko": _PACK(
        "Simple GLP - GLP-1 주사 기록",
        "GLP1 오젬픽 위고비 젭바운드",
        _KO_DESC,
        "마운자로,세마글루타이드,티르제파타이드,펩타이드,알림,프라이빗,용량,주간,주사,기록",
    ),
    "zh-Hans": _PACK(
        "Simple GLP - GLP-1注射记录",
        "GLP1 奥泽匹克 维戈维 泽普",
        _ZH_HANS_DESC,
        "司美格鲁肽,替尔泊肽,玛仕度肽,肽,提醒,私密,剂量,每周,注射,记录,日志",
    ),
    "zh-Hant": _PACK(
        "Simple GLP - GLP-1注射記錄",
        "GLP1 奧澤匹克 維戈維 澤普",
        _ZH_HANT_DESC,
        "司美格魯肽,替爾泊肽,瑪仕度肽,肽,提醒,私密,劑量,每週,注射,記錄,日誌",
    ),
    "ar-SA": _PACK(
        "Simple GLP - متتبع GLP-1",
        "GLP1 أوزمبيك ويجوفي زيباوند",
        _AR_DESC,
        "mounjaro,semaglutide,tirzepatide,ببتيد,تذكير,حقن,خاص,جرعة,أسبوعي,دواء,تسجيل",
    ),
    "he": _PACK(
        "Simple GLP - יומן GLP-1",
        "GLP1 אוזמפיק ווגובי זפבונד",
        _HE_DESC,
        "mounjaro,semaglutide,tirzepatide,פפטיד,תזכורת,זריקה,פרטי,מינון,שבועי,יומן",
    ),
    "th": _PACK(
        "Simple GLP - บันทึก GLP-1",
        "GLP1 โอเซมปิก เวโกวี เซปบาวน",
        _TH_DESC,
        "mounjaro,semaglutide,tirzepatide,เปปไทด์,เตือน,ฉีด,ส่วนตัว,ขนาด,รายสัปดาห์,ยา,บันทึก",
    ),
    "vi": _PACK(
        "Simple GLP - Nhật ký GLP-1",
        "GLP1 Ozempic Wegovy Zepbound",
        _VI_DESC,
        "mounjaro,semaglutide,tirzepatide,peptide,nhắc,tiêm,riêng,liều,hàngtuần,thuốc,nhật ký",
    ),
    "id": _PACK(
        "Simple GLP - Log GLP-1",
        "GLP1 Ozempic Wegovy Zepbound",
        _ID_DESC,
        "mounjaro,semaglutide,tirzepatide,peptida,pengingat,suntik,privat,dosis,mingguan,obat,catatan",
    ),
    "ms": _PACK(
        "Simple GLP - Log GLP-1",
        "GLP1 Ozempic Wegovy Zepbound",
        _MS_DESC,
        "mounjaro,semaglutide,tirzepatide,peptida,peringatan,suntikan,peribadi,dos,mingguan,ubat,log",
    ),
}
