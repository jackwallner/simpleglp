...
/// On-device record of how someone met GLP Pro before they bought it: which
...
enum ConversionDiagnostics {
    private static let logger = Logger(subsystem: "com.jackwallner.glp", category: "Conversion")
    ...
    private static let impressionPrefix = "simpleglp_"
